...
import img4 from '../../images/virat.png'
import img5 from '../../images/RCB.png'
...
const Post2 = () => {
    ...
    const desc = `Honoured to lead Team RCB to victory in the IPL 2025! This win is a testament to our hard work, unity, and belief. Immense gratitude to the support staff, fans, and every teammate. Proud moment for Indian cricket. Let's keep striving for excellence and making our country proud!`
    return (
        <Card padding={0}>
            <div className='flex gap-3 p-4'>
                ...
                <div>
                    ...
                    <div className='text-sm text-gray-500' style={{ fontWeight: '550' }}>Indian Cricketer | 4X ODI POTT | ICC Champions Trophy | IPL 2025</div>
                </div>
            </div>
            ...
            <div className='my-2 p-4 flex justify-between items-center'>
                <div className='flex gap-2 items-center'>
                    <ThumbUpIcon style={{ color: '#E55050', fontSize: '14' }} /> <div className='text-sm text-gray-700'>100k+ Likes</div>
                </div>
                <div className='flex gap-2 items-center'>
                    <CommentOutlinedIcon style={{ color: '#0D5EA6', fontSize: '14' }} /> <div className='text-sm text-gray-700'>100k+ Comments</div>
                </div>
            </div>
                ...
                comment && <div className='p-4 w-full'>
                    ...
                    <div className='w-full p-4'>
                        ...
                        <div className='my-4'>
                            ...
                            <div className='px-11 my-2'>Finally! We are the champions! 🥳🙌</div>
                        </div>
