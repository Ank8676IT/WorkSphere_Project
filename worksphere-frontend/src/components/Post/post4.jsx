...
import img4 from '../../images/raj.png'
import img5 from '../../images/vijay2.png'
...
const Post4 = () => {
    ...
    const desc = `Had a thought-provoking conversation with Vijay Mallya on my latest podcast. While I appreciate his openness about entrepreneurship and setbacks, I challenged some of his perspectives on accountability and leadership. It's crucial we learn from both successes and mistakes. Tune in for a balanced discussion on business and integrity.`
    return (
        <Card padding={0}>
            <div className='flex gap-3 p-4'>
                ...
                <div>
                    <div className='text-lg font-semibold'>Raj Shamani</div>
                    <div className='text-sm text-gray-500' style={{ fontWeight: '550' }}>Podcast <a href="https://www.youtube.com/@rajshamani" target="_blank" rel="noopener noreferrer" className="text-blue-600">@Youtube</a> | Motivational Speaker | Social Media Influencer </div>
                </div>
            </div>
            ...
            <div className='my-2 p-4 flex justify-between items-center'>
                <div className='flex gap-2 items-center'>
                    <ThumbUpIcon style={{ color: '#E55050', fontSize: '14' }} /> <div className='text-sm text-gray-700'>1k+ Likes</div>
                </div>
                <div className='flex gap-2 items-center'>
                ...
                comment && <div className='p-4 w-full'>
                    ...
                    <div className='w-full p-4'>
                        ...
                        <div className='my-4'>
                            ...
                            <div className='px-11 my-2'>Appreciate the insights shared.</div>
                        </div>
