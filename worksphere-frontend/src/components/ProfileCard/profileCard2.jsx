...
import img7 from '../../images/cover1.png'
...
const ProfileCard2 = () => {
    return (
        <Card padding={0}>
            ...
            <div className='p-5'>
                <div className='text-xl' style={{ fontWeight: 600}}>Aarav Devendra</div>
                <div className='text-md my-1' style={{ fontWeight: 580}}>DTU | Final Year</div>
